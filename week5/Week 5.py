...
def newFunction():
    ...
    """
    pass    # this is an empty statement, similar to null, lets you write out the structure of your program
...
# Python is an object-oriented programming language, and classes form the framework for this practice.

class Calculator:
    """
    A basic example of a class. This creates an object that you can later change with its own built-in functions.
    When you create a new calculator object, the default value will be 0.
    Calculator() creates a new object with value=0 everytime it's called. So to use the calculator object, save it as a
    new variable eg 'calc':
    $ calc = Calculator()
...
# you'll need to change the file variable to your own filepath
